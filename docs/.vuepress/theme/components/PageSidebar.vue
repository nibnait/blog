    ...
    <div class="page-side-toolbar">
        ...
        <div class="toc-container">
            <div class="pos-box">
              ...
              <div class="scroll-box" style="text-align:center" >
                ...
                <img v-bind="{src: 'https://api.qrserver.com/v1/create-qr-code/?data=https://tianbin.cc'+this.$route.fullPath }" height="180px" style="margin:10px;"/>
      ...
      <div class="option-box" v-if="next" style="padding-left:2px;text-align:center;" v-bind:title="next.title">
          <router-link v-if="next" :to="next.path" >
            <img src="/images/system/next.png" width="30px" class="nozoom" />
...
export default {
  ...
  components: { PageSidebarToc, PageSidebarBackToTop },
