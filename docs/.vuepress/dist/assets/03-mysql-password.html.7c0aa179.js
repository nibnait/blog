import{_ as s,o as n,c as a,e}from"./app.1432ef2b.js";const i={},l=e(`<h1 id="mysql-\u5BC6\u7801\u5FD8\u4E86" tabindex="-1"><a class="header-anchor" href="#mysql-\u5BC6\u7801\u5FD8\u4E86" aria-hidden="true">#</a> mysql \u5BC6\u7801\u5FD8\u4E86</h1><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">vim</span> /etc/my.cnf
skip-grant-tables
